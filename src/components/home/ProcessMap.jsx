  ...
  <div className="grid lg:grid-cols-2 gap-6 items-center">
    ...
    > 
     ...
     Try our Free Process Map Generator
      ...
      <button type="submit" className="bg-risd-blue rounded-lg 
      lg:min-h-[56px] min-h-[50px] text-nowrap md:text-base text-sm px-5 font-semibold hover:scale-105 transition-all duration-300 ease-in-out">
     Try it For Free
      </button>
    </motion.div>
    <motion.div className="flex justify-center lg:justify-end"
     ...
     transition={{duration: 0.8, ease: "easeInOut"}} 
    >
      <img src={Images.process_map} alt="process map"  />
